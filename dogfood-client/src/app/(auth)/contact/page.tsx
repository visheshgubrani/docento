...
import { FiArrowRight, FiBookOpen, FiMail, FiMessageSquare, FiUser } from "react-icons/fi";
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-foreground/70">Tell us what you need help with</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 border border-muted-foreground placeholder:text-muted-foreground py-5 ${errors.name ? "border-red-700" : ""
                  }`}
              />
            </div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                disabled={isSubmitting}
                className={`pl-10 border border-muted-foreground placeholder:text-muted-foreground py-5 ${errors.subject ? "border-red-700" : ""
                  }`}
              />
            </div>
            {errors.subject ? <p className="text-sm text-red-700">{errors.subject}</p> : null}
            ...
            <div className="relative">
              ...
              <Textarea
                ...
                disabled={isSubmitting}
                className={`min-h-32 pl-10 border border-muted-foreground placeholder:text-muted-foreground ${errors.message ? "border-red-700" : ""
                  }`}
              />
            </div>
          ...
          <p className="text-center text-sm text-foreground/90 mt-6">
            Prefer email?{" "}
            <a href="mailto:support@acmelearning.com" className="text-primary underline font-medium">

    ...
    <div className="space-y-8 bg-dashboard-bg">
      ...
      <div className="sticky top-0 z-10 space-y-3 -mx-4 md:-mx-6 xl:-mx-10 px-4 md:px-6 xl:px-10 pt-0 pb-4">
        ...
        <p className="text-lg font-stix text-foreground/80 tracking-wide">
          Set up a new project to organize your courses and manage student
          enrollments
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-foreground/60">
            Choose how users will authenticate to access this project
          </p>
          <p className="text-xs text-foreground/50">
            <strong className="text-foreground/70 font-medium">Managed:</strong>{' '}
            Docento stores and manages student credentials. <br />

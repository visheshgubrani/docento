...
export default function CourseCertificatesPage() {
  ...
  const handleToggle = async (enabled: boolean) => {
    ...
    try {
      ...
      toast({
        title: enabled ? 'Certificates enabled' : 'Certificates disabled',
        description: enabled
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-foreground/70 max-w-3xl mb-10 leading-relaxed">
              With this feature, you can award certificates of completion to
              students who finish your course. Certificates serve as proof of
              achievement and can help motivate learners to complete the course.
            </p>

    ...
    useEffect(() => {
        ...
        fetchLessonPlaybackSession(projectId, courseId, moduleId, lessonId)
            ...
            .catch((error) => {
                if (!isActive) return
                const message =
                    error instanceof Error ? error.message : 'Failed to load video playback.'
            ...
            <div className='p-4'>
                ...
                {isFailed && (
                    <div className='flex flex-col items-center justify-center py-12 text-center'>
                        ...
                        <p className='mt-4 font-medium text-destructive'>Processing Failed</p>
                        <p className='text-sm text-foreground/60 mt-1'>
                    ...
                    <div className='space-y-3'>
                        {isLoadingPlayback && (
                            <div className='flex flex-col items-center justify-center py-12 text-center'>
                                ...
                                <p className='mt-4 font-medium text-foreground'>Loading video...</p>
                                <p className='text-sm text-foreground/60 mt-1'>
                        ...
                        {!isLoadingPlayback && playbackError && !playbackSession && (
                            <div className='flex flex-col items-center justify-center py-12 text-center'>
                                ...
                                <p className='mt-4 font-medium text-destructive'>Playback unavailable</p>
                                <p className='text-sm text-foreground/60 mt-1'>{playbackError}</p>
                            </div>
                        )}

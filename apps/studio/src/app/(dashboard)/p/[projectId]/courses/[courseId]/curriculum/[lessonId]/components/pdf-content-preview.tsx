...
export function PdfContentPreview({
  ...
  const displayName =
    pdfIndex !== -1 ? rawName.substring(0, pdfIndex) + '.pdf' : rawName
    ...
    <div className="rounded-md border bg-card p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex mt-1 items-center justify-center flex-shrink-0">
          <Image src="/images/icons/pdf.svg" alt="PDF" width={42} height={42} />
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              ...
              size="sm"
              variant="default"
              className="bg-accent/70 hover:bg-accent/80 rounded-sm cursor-pointer"
            >
            ...
            <Button
              ...
              size="sm"
              variant="outline"
              className="rounded-sm cursor-pointer hover:text-foreground"
            >

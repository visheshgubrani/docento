...
const VERIFICATION_ERRORS: Record<string, string> = {
  token_expired: 'This verification link has expired. Request a new one from the login page.',
  invalid_token: 'This verification link is invalid. Request a new one from the login page.',
...
function EmailVerifiedPageContent() {
  ...
  const error = errorCode ? VERIFICATION_ERRORS[errorCode] || 'Email verification failed.' : null

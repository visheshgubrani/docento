    ...
    <div className="min-h-screen py-20">
      <div className="mx-auto w-full max-w-4xl px-6 lg:px-10">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          These Terms govern your use of {siteConfig.name} and its learning
          services.
        </p>
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-foreground/85">
          ...
          <section>
            ...
            <p className="mt-2">
              Purchased courses are for your personal use only unless stated
              otherwise. You may not copy, redistribute, or resell course
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              Pricing and offers may change at any time unless already
              purchased.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ${siteConfig.name} may update course content, features, and
              policies to improve the platform and maintain service quality.
            </p>
          </section>

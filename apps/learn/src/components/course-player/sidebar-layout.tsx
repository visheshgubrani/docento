...
export function CoursePlayerSidebar({
  ...
  const normalizedCompletionPercent = Math.max(
    0,
      ...
      >
        <div className="my-1 flex h-14 items-center px-2.5 md:my-3 md:px-3">
          <button
            ...
            aria-label={
              isOpen ? 'Collapse lesson sidebar' : 'Expand lesson sidebar'
            }
          >
                    ...
                    {module.lessons.map((lesson) => {
                      ...
                      return (
                        <Link
                          ...
                          onClick={(event) =>
                            handleLessonNavigation(event, lesson.id)
                          }
                          className={cn(
                        ...
                        >
                          ...
                          <span className="leading-5.5 text-xs">
                            {lesson.title}
                          </span>
                        </Link>
                      )

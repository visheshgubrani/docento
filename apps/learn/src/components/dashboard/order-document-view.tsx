        ...
        {variant === 'invoice' ? (
          <>
            ...
            <View style={pdfStyles.detailsGrid}>
              <View style={pdfStyles.detailCard}>
                ...
                <Text style={[pdfStyles.bodyText, pdfStyles.bodyStrong]}>
                  {student.name}
                </Text>
              ...
              <View style={pdfStyles.detailCard}>
                ...
                <Text style={pdfStyles.bodyText}>
                  Transaction: {order.providerTxId || 'N/A'}
                </Text>
                <Text style={pdfStyles.bodyText}>
                  Method: {formatPaymentType(order.provider)}
                </Text>
            ...
            <View style={pdfStyles.table}>
              <View style={pdfStyles.tableHeader}>
                <Text style={[pdfStyles.labelText, pdfStyles.tableCellGrow]}>
                  Item Description
                </Text>
                <Text style={[pdfStyles.labelText, pdfStyles.tableCellRight]}>
                  Price
                </Text>
              </View>
              <View style={pdfStyles.tableRow}>
                <View style={pdfStyles.tableCellGrow}>
                  ...
                  <Text style={pdfStyles.smallMuted}>
            ...
            <View style={pdfStyles.summaryRow}>
              ...
              <Text style={pdfStyles.summaryValue}>
                {formatPdfAmount(0, order.currency)}
              </Text>
            </View>
          ...
          <>
            ...
            <View style={pdfStyles.table}>
              ...
              <View style={pdfStyles.tableRow}>
                <Text style={[pdfStyles.valueText, pdfStyles.tableCellGrow]}>
                  {course.title}
                </Text>
                <Text style={[pdfStyles.valueText, pdfStyles.tableCellRight]}>
                  {formatPdfAmount(order.amount, order.currency)}
...
export function OrderDocumentView({ data, variant }: OrderDocumentViewProps) {
  ...
  const documentFileName =
    makeSafeFileName(
      `${tenant.name}-${course.title}-${order.id.slice(0, 8)}`,
    ) || 'document'
  ...
  async function handleDownloadPdf() {
    try {
      ...
      const blob = await pdf(
        <OrderDocumentPdf data={data} variant={variant} />,
      ).toBlob()
